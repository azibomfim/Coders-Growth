...
{
    partial class FormEdicaoPersonagem
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            MaximizeBox = false;
            Name = "FormEdicaoPersonagem";
            Text = "Cadastro de Personagem";
            Load += aoCarregarTelaDeEdicao;
            ResumeLayout(false);
            PerformLayout();
        }
